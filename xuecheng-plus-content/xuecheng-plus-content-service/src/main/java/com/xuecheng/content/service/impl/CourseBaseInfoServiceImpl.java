...
//        courseBaseNew.setDescription(dto.getDescription());
    ...
    public CourseBaseInfoDto getCourseBaseInfo(Long courseId){
        ...
        List<CourseCategoryTreeDto> treeDtos = courseCategoryMapper.selectTreeNodes(String.valueOf(courseId));
        if (treeDtos==null){
            return null;
        }
        BeanUtils.copyProperties(treeDtos,courseBaseInfoDto);
...
//               throw new RuntimeException("课程的价格不能为空并且必须大于0");
               XueChengPlusException.cast("课程的现价不能为空并且必须大于0");
           }
        }
